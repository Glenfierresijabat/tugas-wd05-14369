<!-- resources/views/layout/pasien.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('pasien.dashboard') }}" class="nav-link">Beranda</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('pasien.dashboard') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Poliklinikku</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025 <a href="https://github.com/Hessaajipradana/tugas-wd05-14393">Poliklinikku@14369</a>.</strong>
    All rights reserved.
